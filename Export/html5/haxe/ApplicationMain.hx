...
@:dox(hide) class ApplicationMain {
	...
	public static function main () {
		...
		lime.system.System.__registerEntryPoint ("Tracktest", create);
		
		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed ("Tracktest", null, 0, 0);
		#end
		#else
		create (null);
		#end
	...
	public static function create (config):Void {
		...
		app.meta["file"] = "Tracktest";
		app.meta["name"] = "Tracktest";
		app.meta["packageName"] = "com.sample.tracktest";
